...
class Member extends Authenticatable implements JWTSubject
{
    ...
    protected $fillable = [
         'name', 'username', 'phone', 'password', 'referrer_id', 'referrer_code', 'partner_code', 'balance','phoneverify','approved','gender','blood','religion','monthlyincome','profession','nationality','married','division','district','upazila','verified','city', 'country', 'status'
    ];
