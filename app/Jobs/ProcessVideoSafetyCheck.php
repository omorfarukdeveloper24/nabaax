    ...
    public function handle()
    {
        ...
        try {
            ...
            if ($isSafe) {
                ...
                $this->sendFcmNotification($post->member_id, "Video Live!", "Your video is ready.");
            } else {
